...
instance C.ToVal Hello where
  toVal Hello
    ...
    [ ("lang", C.toVal helloLang)
    , ("who", C.toVal helloWho)
    ]
...
instance C.ToVal Lang where
  toVal = \case
    Lang'English -> C.Val'ApiVal P.$ C.ApiVal'Enumeral P.$ C.Enumeral "English" P.Nothing
    Lang'Spanish -> C.Val'ApiVal P.$ C.ApiVal'Enumeral P.$ C.Enumeral "Spanish" P.Nothing
    Lang'French -> C.Val'ApiVal P.$ C.ApiVal'Enumeral P.$ C.Enumeral "French" P.Nothing

instance C.FromVal Lang where
  fromVal = \case
    C.Val'ApiVal (C.ApiVal'Enumeral (C.Enumeral _tag _m)) -> case (_tag,_m) of
      ("English", P.Nothing) -> P.Just Lang'English
      ("Spanish", P.Nothing) -> P.Just Lang'Spanish
      ("French", P.Nothing) -> P.Just Lang'French
      _ -> P.Nothing
    _ -> P.Nothing

instance R.ToJSON Lang where
  toJSON = R.toJSON P.. C.toVal

instance R.FromJSON Lang where
  parseJSON _v = do
    _x <- R.parseJSON _v
    case C.fromVal _x of
      P.Nothing -> P.mzero
...
helloWorld'spec = v
  where P.Just v = R.decode "{\"fluid\":{\"major\":0,\"minor\":0},\"pull\":{\"protocol\":\"http\",\"name\":\"HelloWorld\",\"host\":\"localhost\",\"path\":\"/\",\"port\":8080,\"meta\":\"Unit\",\"error\":\"Unit\"},\"schema\":{\"Lang\":[\"English\",\"Spanish\",\"French\"],\"Hello\":{\"m\":[{\"lang\":\"Lang\"},{\"who\":\"String\"}],\"o\":\"String\"},\"Goodbye\":{\"m\":[{\"who\":\"String\"}],\"o\":\"String\"}},\"version\":{\"major\":1,\"minor\":0}}"
